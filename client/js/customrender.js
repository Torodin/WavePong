/**
 * The `Matter.CustomRender` module is a simple HTML5 canvas based renderer for visualising instances of `Matter.Engine`.
...
(function () {
    ...
    /**
     * Ends execution of `CustomRender.run` on the given `render`, by canceling the animation frame request event loop.
     * @method stop
     * @param {render} render
     */
    ...
    /**
     * CustomRenders the given `engine`'s `Matter.World` object.
    ...
    CustomRender.world = function (render) {
        ...
        Events.trigger(render, 'beforeCustomRender', event);
        ...
        Events.trigger(render, 'afterCustomRender', event);
    };
    ...
    CustomRender.bodies = function (render, bodies, context) {
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
                ...
                // Añadimos renderizacion de texto
                if (part.render.text) {
    ...
    /**
     * CustomRenders body vertex numbers.
     * @private
    ...
    /**
     * A back-reference to the `Matter.CustomRender` module.
     *
     * @property controller
     * @type render
     */
     ...
     * CustomRendering will be automatically transformed and scaled to fit within the canvas size (`render.options.width` and `render.options.height`).
     ...
     *
     * @property context
     * @type CanvasCustomRenderingContext2D
     */
